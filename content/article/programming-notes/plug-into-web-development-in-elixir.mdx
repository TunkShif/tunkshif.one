...
description: 本文介绍了如何使用 Elixir 语言和 Plug 库来开发 Web 应用。从 Plug 的概念和作用开始，介绍了如何创建和组合不同类型的 Plug，如 Module Plug、Function Plug 和 Router Plug。文章还展示了如何使用 Plug 来处理请求、响应、会话、日志和异常。
created: 2021-08-18
updated: 2021-08-18
banner:
